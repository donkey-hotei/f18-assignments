...
\begin{enumerate}
    ...
    \item $(\app{\fun{x}{x}}{x})(\app{\fun{x}{x}}{x}) \mapsto (\app{\fun{x}{x}}{x})(\app{\fun{x}{x}}{x}) \mapsto \ldots \par
        Properly evaluated, this expression evalutates to itself repeatedly (i.e: reaches a fixpoint) ($e \mapsto e$).
